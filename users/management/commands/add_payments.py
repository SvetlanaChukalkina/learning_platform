...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        payments = [
            {'user': user, 'date': '2025-01-01', 'payment_for_course': 1, 'total_payment': 5000, 'type': 'перевод'},
            {'user': user, 'date': '2025-05-05', 'payment_for_lesson': 1, 'total_payment': 1000, 'type': 'наличные'},
        ]
